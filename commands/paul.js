...
module.exports = {
    ...
    async execute(interaction, options, args){
        ...
        .addFields(
            ...
            {name: 'Bleach Powers:', 
            value: 'Reiatsu level 428,000, Kido Proficiency 25, Hado No. 11 Tsuzuri Raiden, Hado No. 96 Itto Kaso, Bakudo No. 4 Hainawa, Bakudo No. 63 Sajosabaku, Sight Sharing, Zanpakuto: Thunder Bird (controls the weather), Bankai: Elemental Storm (Powers up the users elemental abilities)'},
