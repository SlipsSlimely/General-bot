...
module.exports = {
    ...
    async execute(interaction, options, args){
        ...
        .addFields(
            ...
            value: 'Drawing'},
            {name: 'Bleach Powers:', 
            value: 'Reiatsu level ???, Kido Master, Perfect Hypnosis, Control of the Hogyoku, Instant Regeneration, Immortal, Dimensional Travel, Genius Intellect'},
            {name: `JoJo's Bizarre Adventure Powers:`, 
            value: 'Stand; ???, High stats and can give someone a heart attack but only 3 times ever'},
        )
